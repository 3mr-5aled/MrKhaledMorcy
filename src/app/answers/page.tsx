...
export const metadata: Metadata = {
  title: "إجابات الكتب والامتحانات | مستر خالد مرسي",
  description:
    "إجابات الكتب المدرسية والامتحانات للغة الإنجليزية مع مستر خالد مرسي",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            اختر صفك الدراسي للوصول إلى إجابات الكتب والامتحانات
          </p>
        </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                يتم حالياً إعداد إجابات الكتب والامتحانات. ترقبوا التحديثات
                قريباً!
              </p>
            </div>
          </div>
          ...
          {grades.map((grade) => (
            ...
            >
              ...
              <p className="text-gray-500 text-sm mb-4">
                إجابات الكتب والامتحانات ستكون متاحة قريباً
              </p>

              <div className="space-y-2">
                <div className="w-full py-2 px-3 rounded-lg bg-gray-50 text-gray-400 text-sm flex items-center gap-2">
                  <svg
                    className="w-4 h-4"
                    fill="none"
                    stroke="currentColor"
                  ...
                  <span>إجابات الكتاب المدرسي</span>
                </div>
                <div className="w-full py-2 px-3 rounded-lg bg-gray-50 text-gray-400 text-sm flex items-center gap-2">
                  <svg
                    className="w-4 h-4"
