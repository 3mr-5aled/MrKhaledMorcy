...
export const metadata: Metadata = {
  title: "الاختبارات | مستر خالد مرسي",
  description: "اختبر نفسك وقيّم مستواك في اللغة الإنجليزية مع مستر خالد مرسي",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            اختر صفك الدراسي للوصول إلى الاختبارات المتاحة
          </p>
        </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                يتم حالياً إعداد الاختبارات التفاعلية. ترقبوا التحديثات قريباً!
              </p>
            </div>
          </div>
        </div>
